...
<div id="content">
	<div class="grid_container">
		...
		<c:choose>
			...
			<c:otherwise>
				<h4 style="text-align: center;">Model Schedule Variance
...
function dashboard(id, fData){
    ...
    function segColor(c){ return {On_Schedule:"#41ab5d", Over_Schedule:"#e08214",Under_Schedule:"purple"}[c]; }
    
    // compute total for each state.
    fData.forEach(function(d){d.total=d.freq.On_Schedule+d.freq.Over_Schedule+d.freq.Under_Schedule;});
    ...
    var hG = histoGram(sF), // create the histogram.
		...
		<script>
var freqData=[
{State:'Oncology Care Model',freq:{On_Schedule:4, Over_Schedule:3, Under_Schedule:1}}
,{State:'Million Hearts',freq:{On_Schedule:1, Over_Schedule:3, Under_Schedule:2}}
,{State:'Comprehensive ESRD Care',freq:{On_Schedule:2, Over_Schedule:1, Under_Schedule:2}}
];
					...
					<table class="display data_tbl" id="dashboard">
						<thead>
							<tr>
								...
								<th title="Program Names with project dropdown">Model Name</th>

								<th title="No of Projects">Start Date</th>
								<th title="No of Projects">End Date</th>
							...
							<c:forEach var="program" items="${programs}" varStatus="loop">
								...
								<c:forEach var="project" items="${program.projects}">
									<tr>
										...
										<td><a class="${linkcolor }"><c:out
													value='${project.startDate}' /></a></td>
										<td><a class="${linkcolor }"><c:out
													value='${project.endDate}' /></a></td>
										<td><a class="${linkcolor }"><c:out
										...
										<ul class="list_info">
											...
											<li><span>Activity: <c:out
														value="${artifact.entityType}" /> <b><c:out
															value="${artifact.entityName} " /></b>
												<c:out value=" was " /> <i><c:out
															value="${artifact.activityType}D" /></i></span></li>
											<li><span>By: <i><c:out
