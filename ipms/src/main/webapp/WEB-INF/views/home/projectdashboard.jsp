...
<div id="content">
	...
	<!--  D3.js code starting -->
<h4 style="padding-left:450px;">Model Status</h4>
						...
						<table class="display data_tbl" id="dashboard">
							<thead>
								<tr>
									...
									<th title="Program Assigned to Project">Model</th>
			...
			<div class="widget_wrap">
				...
				<div class="widget_content">
					...
					<table class="display data_tbl" id="dashboard">
						...
						<tbody>
							<c:forEach var="actionitem" items="${actionItems}" end='4'>
								<tr>
									<td><a
