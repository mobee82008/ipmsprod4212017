...
<div id="breadcrumb">
	<ul>
		<li><a href="${pageContext.request.contextPath}/app/dashboard">Home</a>
			<span> >> </span></li>
		<li><a href="${pageContext.request.contextPath}/app/programs">Groups</a>
			<span> >> </span></li>
		<li><a href="#" style="text-decoration: none;">Edit Group</a></li>
	</ul>
</div>
<div class="content">
		...
		<div class="grid_12 full_block">
			<div class="widget_wrap">
				...
				<div class="widget_content">
					<h6>
						Edit Group :
						<c:out value='${organizationGroup.name}' />
					</h6>
					<form:form modelAttribute="organizationGroup"
						class="form_container left_label"
						action="${pageContext.request.contextPath}/app/edit-organization-group"
						method="post">
									...
									<ul>
										...
										<li>
											<div class="form_grid_12">
												...
												<div class="form_input">
													<form:input type="text" name="dateCreated" id="dateCreated"
